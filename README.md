...
<p align="center">
  <strong>Unified Model Context Protocol server that merges PG-Git codebase search with Krusch Context MCP.</strong>
</p>
...
graph TD;
    ...
    B -- Episodic Memory --> D[(Krusch Context MCP: ide_agent_memory)];
    B -- Deep Search --> C;
    B -- Deep Search --> D;
```

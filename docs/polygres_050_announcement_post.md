# 🐘 Polygres v0.5.0 & Native Embeddings Integration Post

> **Author**: Kevin Ruschman (@kruschdev)  
> **Date**: September 16, 2026  
> **Tags**: `#AI` `#MCP` `#PostgreSQL` `#Polygres` `#AgenticRAG` `#DeveloperTools`
...
We just upgraded our open-source agent context server (krusch-context-mcp) to Polygres v0.5.0:
